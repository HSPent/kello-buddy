    ...
    <section className="py-20 sm:py-28 bg-gradient-to-b from-spring-pink/40 via-[#fdf2f7] to-white relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-5xl relative z-10">
        <ScrollReveal width="100%">
          <div className="relative rounded-[2rem] sm:rounded-[3.5rem] overflow-hidden shadow-[0_20px_60px_-15px_rgba(168,68,141,0.12)] border border-white/60 bg-white group">
            <img 
              src="/그래프11.png" 
